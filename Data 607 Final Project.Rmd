...
The National Highway Traffic Safety Administration Recommendations provide a basis for vehicle safety for crash worthiness and rollover. The recommendation image provides a baseline for head, leg and chest injury.  In summary, the close the value is to absolute 0, the more likely the occupant will have less severe injury.   
